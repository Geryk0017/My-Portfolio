    ...
    >
      ...
      <div class="relative p-6">
        ...
        <div class="mt-4 space-y-2 md:h-[100px]">
          <h3 class="text-xl font-semibold text-white">Dependable Friend</h3>
          <p class="text-slate-400">
            Even outside of schoolwork, he was someone we could count on for ideas and support. A
            true teammate.
          </p>
        </div>
        ...
        <div class="mt-6 flex items-center gap-4">
          <div class="group/avatar relative">
            ...
            <div class="relative rounded-full bg-slate-950 ring-2 ring-slate-950">
              <img :src="Prince" alt="" class="rounded-full w-[50px] h-[50px]" />
            </div>
          </div>
          <div>
            <h4 class="font-semibold text-white">Prince Batulan</h4>
...
<script setup>
import Prince from '@/assets/img/prince.jpg'
</script>
