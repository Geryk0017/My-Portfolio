<template>
  <div class="group relative mt-10 md:w-[480px]">
    <div
    ...
    >
      ...
      <div class="relative p-6">
        <div class="absolute right-6 top-6">
          <svg viewBox="0 0 24 24" fill="currentColor" class="h-12 w-12 text-indigo-500/10">
            <path
        ...
        <div class="mt-4 space-y-2 md:h-[100px]">
          <h3 class="text-xl font-semibold text-white">Reliable Front-End Lead</h3>
          <p class="text-slate-400">
            Working with Geryk on our capstone project was a great experience. He took charge of the
            front-end, always making sure our system was responsive and user-friendly while keeping
            the team motivated.
          </p>
        </div>
        ...
        <div class="mt-6 flex items-center gap-4">
          <div class="group/avatar relative">
            ...
            ></div>
            <div class="relative rounded-full bg-slate-950 ring-2 ring-slate-950">
              <img :src="sylvest" alt="" class="rounded-full w-[50px] h-[50px]" />
            </div>
          </div>
          <div>
            <h4 class="font-semibold text-white">Sylvest Madelo</h4>
            <p class="text-sm text-slate-400">Capstone Groupmate</p>
          </div>
        </div>
        ...
        <div class="mt-6 flex items-center justify-between">
          <div class="flex items-center gap-2">
            ...
            >
              <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" class="h-5 w-5">
                <path
...
<script setup>
import sylvest from '@/assets/img/sylvest.jpg'
</script>
