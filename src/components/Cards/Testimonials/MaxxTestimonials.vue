    ...
    >
      ...
      <div class="relative p-6">
        ...
        <div class="mt-4 space-y-2 md:h-[100px]">
          <h3 class="text-xl font-semibold text-white">Great Leader</h3>
          <p class="text-slate-400">
            Back in college, Geryk was always the go-to person whenever we got stuck on projects.
            Super reliable!
          </p>
        </div>
        ...
        <div class="mt-6 flex items-center gap-4">
          <div class="group/avatar relative">
            ...
            <div class="relative rounded-full bg-slate-950 ring-2 ring-slate-950">
              <img :src="Maxx" alt="" class="rounded-full w-[50px] h-[50px]" />
            </div>
          </div>
          <div>
            <h4 class="font-semibold text-white">Johanna Maxxine Dolz</h4>
...
<script setup>
import Maxx from '@/assets/img/maxx.jpg'
</script>
