    ...
    >
      ...
      <div class="relative p-6">
        ...
        <div class="mt-4 space-y-2 md:h-[100px]">
          <h3 class="text-xl font-semibold text-white">Detail-Oriented Teammate</h3>
          <p class="text-slate-400">
            Whenever we had projects in class, he was the one who made sure our outputs looked
        ...
        <div class="mt-6 flex items-center gap-4">
          <div class="group/avatar relative">
            ...
            <div class="relative rounded-full bg-slate-950 ring-2 ring-slate-950">
              <img :src="atan" alt="" class="rounded-full w-[50px] h-[50px]" />
            </div>
          </div>
          <div>
            <h4 class="font-semibold text-white">Jonathan Mariano</h4>
...
<script setup>
import atan from '@/assets/img/atan.jpg'
</script>
