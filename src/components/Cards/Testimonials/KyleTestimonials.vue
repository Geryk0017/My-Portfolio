    ...
    >
      ...
      <div class="relative p-6">
        ...
        <div class="mt-4 space-y-2 md:h-[100px]">
          <h3 class="text-xl font-semibold text-white">Always Supportive</h3>
          <p class="text-slate-400">
            Geryk has always been the type of friend who motivates me to keep learning. He’s
            supportive and never hesitates to share his knowledge when I need help.
          </p>
        </div>
        ...
        <div class="mt-6 flex items-center gap-4">
          <div class="group/avatar relative">
            ...
            <div class="relative rounded-full bg-slate-950 ring-2 ring-slate-950">
              <img :src="Kyle" alt="" class="rounded-full w-[50px] h-[50px]" />
            </div>
          </div>
          <div>
            <h4 class="font-semibold text-white">Kyle Richard Oquindo</h4>
            <p class="text-sm text-slate-400">College Classmate</p>
          </div>
        </div>
